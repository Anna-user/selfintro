...
// // addEventListener를 쓸 때는 처음에 어떤 event인지 써주고 그 담에 함수 써주기
...
//         // //currentIndex가 마지막이라면 처음으로 돌아감, 3000은 3초를 의미
//         // if(currentIndex == (sections.length -1)){
//         //     currentIndex = 0
...
// // 네이버 API를 통해 오늘의 운세 데이터를 가져오기 (비동기 작업)
// fetch("https://m.search.naver.com/p/csearch/content/apirender.nhn?where=nexearch&pkid=387&u2=20011007&q=%EC%83%9D%EB%85%84%EC%9B%94%EC%9D%BC+%EC%9A%B4%EC%84%B8&u1=f&u3=solar&u4=12&_=1719518803829")
...
//         const fortune = doc.querySelector('dd b').textContent; // 운세 제목 추출
//         const fortuneText = doc.querySelector('dd p').textContent; // 운세 내용 추출
